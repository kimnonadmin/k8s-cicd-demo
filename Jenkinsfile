            ...
            steps {
                withCredentials([
                    ...
                    sh '''
                        ...
                        # Cho K8s Controller 5 giay de nhan dien ReplicaSet
                        sleep 5

                        kubectl --server=https://127.0.0.1:16443 --insecure-skip-tls-verify=true -n "$K8S_NAMESPACE" rollout status deployment/myapp --timeout=300s
                    '''
                }
            }
        }
